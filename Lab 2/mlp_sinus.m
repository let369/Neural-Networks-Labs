...
while ~stop_criterium
    ...
    if and((mod(epoch,20)==0),(plot_animation))
        ...
        for x=1:nPoints
            ...
            out(x) = output_function_sin(h_out * w_output); 
        end
        figure(1)
...
if plot_bigger_picture
    ...
    o_big = output_function_sin(h_big * w_output);
